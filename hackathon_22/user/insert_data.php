...
$ct=$_SESSION['city'];
$ps=$_SESSION['ps'];
// $qry = "INSERT INTO Feedback (HOW_COME_PS,WAIT_TIME,BEHAVIOR_PI,FIR,
// COPY_OF_FIR,RATING,TIME_TO_SOLVE,PO_NAME,PO_DESG,SUMMARY) VALUES ('$HOW_COME_PS','$WAIT_TIME','$BEHAVIOR_PI','$FIR','$COPY_OF_FIR','$RATING','$TIME_TO_SOLVE',
// '$PO_NAME','$PO_DESG','$SUMMARY') where $SUB_DIV_ID='$ct'";
$qry = "update feedbackn1 SET HOW_COME_PS='$HOW_COME_PS' , WAIT_TIME='$WAIT_TIME' , BEHAVIOR_PI='$BEHAVIOR_PI' , FIR='$FIR' , COPY_OF_FIR='$COPY_OF_FIR' , RATING='$RATING' , TIME_TO_SOLVE='$TIME_TO_SOLVE' , PO_NAME='$PO_NAME' , PO_DESG='$PO_DESG' , SUMMARY='$SUMMARY' where SUB_DIV_ID='$ct' AND PS_ID='$ps'";
echo "$qry";
